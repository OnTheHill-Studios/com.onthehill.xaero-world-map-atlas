package com.onthehill.templatemod;

import java.nio.file.Path;

import com.onthehill.templatemod.config.ServerProgressConfig;
import com.onthehill.templatemod.network.ModNetworking;
import com.onthehill.templatemod.network.ProgressSyncPayload;
import com.onthehill.templatemod.progress.TickProgressState;
...
public class TemplateMod implements ModInitializer
{
    ...
    public void onInitialize()
    {
        ...
        ModCommands.registerServerCommands(() -> serverConfig, TemplateMod::onAdminConfigApplied);

        ServerLifecycleEvents.SERVER_STARTED.register(TemplateMod::onServerStarted);
    ...
    private static void onServerStarted(MinecraftServer server)
    {
        ...
        ModNetworking.registerServerReceivers(() -> serverConfig, TemplateMod::onAdminConfigApplied);
        ServerTickEvents.END_SERVER_TICK.register(TemplateMod::onServerTick);
    }
