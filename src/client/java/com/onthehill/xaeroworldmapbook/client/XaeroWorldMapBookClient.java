...
import com.onthehill.xaeroworldmapbook.client.render.ProgressHudRenderer;
 ...
 * client-side pieces — see {@code XaeroWorldMapBook}'s Javadoc for why this
...
public class XaeroWorldMapBookClient implements ClientModInitializer
{
    ...
    public void onInitializeClient()
    {
        ...
        HudElementRegistry.addLast(XaeroWorldMapBook.id("progress_hud"), new ProgressHudRenderer(clientConfig));
    }
