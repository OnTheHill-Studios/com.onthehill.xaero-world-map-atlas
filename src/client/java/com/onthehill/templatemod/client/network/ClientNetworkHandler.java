package com.onthehill.templatemod.client.network;

import com.onthehill.templatemod.client.screen.ProgressConfigScreen;
import com.onthehill.templatemod.network.AdminConfigSyncPayload;
import com.onthehill.templatemod.network.OpenAdminScreenPayload;
import com.onthehill.templatemod.network.ProgressSyncPayload;
...
public final class ClientNetworkHandler
{
    ...
    private static float lastSyncedRatePerTick = com.onthehill.templatemod.config.ServerProgressConfig.DEFAULT_PROGRESS_RATE;
    ...
    private static float adminProgressRate = com.onthehill.templatemod.config.ServerProgressConfig.DEFAULT_PROGRESS_RATE;
    private static boolean adminAllowNonOpReadOnlyView = com.onthehill.templatemod.config.ServerProgressConfig.DEFAULT_ALLOW_NON_OP_READ_ONLY_VIEW;

    private ClientNetworkHandler() { }

    /**
     * Registers every client-side receiver. Call once from
     * {@code TemplateModClient.onInitializeClient()}.
     */
    ...
    public static void reset()
    {
        ...
        lastSyncedRatePerTick = com.onthehill.templatemod.config.ServerProgressConfig.DEFAULT_PROGRESS_RATE;
        ticksSinceLastSync = 0;
