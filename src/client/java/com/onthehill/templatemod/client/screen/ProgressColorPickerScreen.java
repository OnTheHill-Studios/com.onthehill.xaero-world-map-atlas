...
public final class ProgressColorPickerScreen extends Screen
{
    ...
    {
        super(Component.translatable("gui.template-mod.color_picker.title"));
        this.owner = owner;
        this.onDone = onDone;
    ...
    protected void init()
    {
        ...
        root.addChild(new StringWidget(200, ROW_HEIGHT, Component.translatable("gui.template-mod.color_picker.title"), this.font));
    ...
    private LinearLayout buildRightColumn()
    {
        ...
        this.hexField = new EditBox(this.font, 0, 0, HEX_FIELD_WIDTH, ROW_HEIGHT,
            Component.translatable("gui.template-mod.color_picker.hex"));
        ...
        this.redSlider = new ProgressColorChannelSlider(0, 0, SLIDER_WIDTH, SLIDER_HEIGHT,
            Component.translatable("gui.template-mod.color_picker.red"), (this.currentRgb >> 16) & 0xFF,
        ...
        this.greenSlider = new ProgressColorChannelSlider(0, 0, SLIDER_WIDTH, SLIDER_HEIGHT,
            Component.translatable("gui.template-mod.color_picker.green"), (this.currentRgb >> 8) & 0xFF,
        ...
        this.blueSlider = new ProgressColorChannelSlider(0, 0, SLIDER_WIDTH, SLIDER_HEIGHT,
            Component.translatable("gui.template-mod.color_picker.blue"), this.currentRgb & 0xFF,
    ...
    private LinearLayout buildButtonRow()
    {
        ...
        buttons.addChild(Button.builder(Component.translatable("gui.template-mod.color_picker.done"), button ->
            {
        ...
        buttons.addChild(Button.builder(Component.translatable("gui.template-mod.color_picker.cancel"), button ->
                Minecraft.getInstance().setScreenAndShow(this.owner))
            .bounds(0, 0, BUTTON_WIDTH, ROW_HEIGHT)
            .build());
