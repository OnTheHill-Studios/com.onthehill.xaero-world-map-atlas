 ...
 * {@code assets/template-mod/textures/gui/widgets/reset.png}, drawn directly
...
final class ProgressConfigResetButton extends Button
{
    private static final Identifier ICON =
        Identifier.fromNamespaceAndPath("template-mod", "textures/gui/widgets/reset.png");

    // Native dimensions of assets/template-mod/textures/gui/widgets/reset.png
